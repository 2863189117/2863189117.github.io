...
$$h_{\mu\nu}(\boldsymbol{x},t)=4G\int\mathrm{d}^3\boldsymbol{x}^{\prime}\frac{S_{\mu\nu}(\boldsymbol{x}^{\prime},t-\\lvert\boldsymbol{x}-\boldsymbol{x}^{\prime}\\rvert)}{\\lvertx-\boldsymbol{x}^{\prime}\\rvert}$$
...
$$\langle R_{\mu\nu}^{(2)}\rangle=\frac{k_{\mu}k_{\nu}}{2}\left(e^{\lambda\rho*}e_{\lambda\rho}-\frac{1}{2}\\lverte^{\lambda}{}_{\lambda}\\rvert^2\right)$$
...
$$\langle t_{\mu\nu}\rangle=\frac{k_{\mu}k_{\nu}}{16\pi G}\left(e^{\lambda\rho*}e_{\lambda\rho}-\frac{1}{2}\\lverte^{\lambda}{}_{\lambda}\\rvert^{2}\right)$$
...
$$\langle t_{\mu\nu}\rangle=\frac{k_{\mu}k_{\nu}}{8\pi G}(\\lverte_{11}\\rvert^2+\\lverte_{12}\\rvert^2)$$

 使用螺旋度的振幅可以写成：

$$\langle t_{\mu\nu}\rangle=\frac{k_\mu k_\nu}{16\pi G}(\\lverte_+\\rvert^2+\\lverte_-\\rvert^2)$$
...
$$\begin{aligned}h_{\mu\nu}(\boldsymbol{x},t)&=4G\int\frac{\mathrm{d}^{3}x^{\prime}}{\\lvertx-x^{\prime}\\rvert}S_{\mu\nu}(x^{\prime},\omega)\\&\times\exp\{-\mathrm{i}\omega t+\mathrm{i}\omega\\lvertx-x^{\prime}\\rvert\}+\mathrm{c.c.}\end{aligned}$$
