...
$$\pm t=r+2GM\ln\left\lvert 1-\frac{r}{2GM}\right\rvert +\mathrm{const.}$$

引入

$$r^*\equiv r^2-2GM\mathrm{ln}\left\lvert 1-\frac{r}{2GM}\right\rvert $$
...
$$ \begin{align}
&t-r-4GM\ln\left\lvert 1-\frac{r}{2GM}\right\rvert =U. \\
&t+r=V
\end{align} $$
...
$$\begin{aligned}&t-r=U,\\&t+r+4GM\ln\left\lvert 1-\frac{r}{2GM}\right\rvert =V.\end{aligned}$$
