...
$$\omega_n=\frac{2\pi}{L}\\lvert\vec{n}\\rvertc$$
...
$$a^{\dagger}a\ket{n} =\hat{N}\\lvertn\rangle=n\\rvertn\rangle.$$

- 

$$\hat{N}a^\dagger\\lvertn\rangle=a^\dagger aa^\dagger\\rvertn\rangle=a^\dagger\\lvertn\rangle+a^\dagger a^\dagger a\\rvertn\rangle=(n+1)a^\dagger\\lvertn\rangle.$$
...
$$\mathcal{M}=\langle f\\lvertH_{\mathrm{int}}\\rverti\rangle.$$
...
$$\begin{aligned}\mathcal{M}_{2\to1}&=\langle\mathrm{atom}_1;n_\omega+1\\lvert(H_I^\dagger a^\dagger+H_Ia)\\rvert\mathrm{atom}_2;n_\omega\rangle\\&=\langle\mathrm{atom}_1\\lvertH_I^\dagger\\rvert\mathrm{atom}_2\rangle\langle n_\omega+1\\lverta^\dagger\\rvertn_\omega\rangle+\langle\mathrm{atom}_1\\lvertH_I\\rvert\mathrm{atom}_2\rangle\langle n_\omega+1\\lverta\\rvertn_\omega\rangle\\&=\mathcal{M}_0^\dagger\langle n_\omega+1\\lvertn_\omega+1\rangle\sqrt{n_\omega+1}+0\\&=\mathcal{M}_0^\dagger\sqrt{n_\omega+1}\end{aligned}$$

 其中 $$\mathcal{M}_0^\dagger=\langle\mathrm{atom}_1\\lvertH_I^\dagger\\rvert\mathrm{atom}_2\rangle$$, 于是有: 

$$\\lvert\mathcal{M}_{2\to1}\\rvert^2=\\lvert\mathcal{M}_0\\rvert^2(n_\omega+1).$$

我们可以类似地考虑一个 $$1\to2$$ 的过程, 不难得到: 

$$\begin{aligned}\mathcal{M}_{1\to2}&=\langle\mathrm{atom}_2;n_\omega-1\\lvertH_I^\dagger a^\dagger+H_Ia\\rvert\mathrm{atom}_1;n_\omega\rangle\\&=\langle\mathrm{atom}_2\\lvertH_I\\rvert\mathrm{atom}_1\rangle\langle n_\omega-1\\lverta\\rvertn_\omega\rangle\\&=\mathcal{M}_0\sqrt{n_\omega}\end{aligned}$$
